...
export const Home = () => {
  ...
  return (
    <div className="container mt-5">
      ...
      <p>
        La aplicación consume distintas APIs públicas para mostrar información
        detallada sobre personajes, objetos, mundos y universos ficticios,
        permitiendo al usuario explorar contenido y guardarlo en una lista de{' '}
        <strong>favoritos / read later</strong>.
      </p>

      <h3 className="mt-5 mb-3">Universos incluidos</h3>

      <div className="row justify-content-center text-center my-4 g-4">
        <div className="col-6 col-md-3">
          <Link to="/pokeapi" className="text-decoration-none text-dark">
            <img
              src={logo_pokeApi}
              alt="PokeAPI"
              style={{ height: '60px' }}
              className="mb-2"
            />
            <h6 className="fw-bold">PokéAPI</h6>
          </Link>
        </div>

        <div className="col-6 col-md-3">
          <Link to="/thesimpsonsapi" className="text-decoration-none text-dark">
            <img
              ...
              className="mb-2"
            />
            <h6 className="fw-bold">Simpsons API</h6>
          </Link>
        </div>

        <div className="col-6 col-md-3">
          <Link to="/bobsburgersapi" className="text-decoration-none text-dark">
            <img
              ...
              className="mb-2"
            />
            <h6 className="fw-bold">Bob’s Burgers API</h6>
          </Link>
        </div>

        <div className="col-6 col-md-3">
          <Link to="/starwarsapi" className="text-decoration-none text-dark">
            <img
              ...
              className="mb-2"
            />
            <h6 className="fw-bold">Star Wars API</h6>
          </Link>
        </div>
      </div>

      <p>
        Para aumentar la dificultad y riqueza del proyecto, la aplicación no se
        limita a una sola API, sino que integra{' '}
      ...
      <ul className="list-unstyled">
        <li className="mb-3">
          Utilizando la{' '}
          <a target="_blank" rel="noreferrer" href="https://www.swapi.tech/">
            <img
              src={logo_theStarWarsApi}
          ...
          de{' '}
          <a target="_blank" rel="noreferrer" href="https://github.com/phalt">
            <i className="fa-brands fa-github"></i> Paul Hallett
          </a>
          , para personajes, planetas y vehículos del universo Star Wars.
        </li>
        ...
        <li className="mb-3">
          ...
          de{' '}
          <a target="_blank" rel="noreferrer" href="https://github.com/Facug03">
        ...
        <li className="mb-3">
          ...
          de{' '}
          <a target="_blank" rel="noreferrer" href="https://github.com/pokeapi">
      ...
      <p>
        Cada elemento puede guardarse en una lista de <strong>favoritos</strong>
        , accesible desde cualquier parte de la aplicación gracias al uso de{' '}
        <strong>Context</strong>. Esto permite al usuario crear su propia lista
        personalizada de contenido para consultar más tarde.
      </p>
      ...
      <ul className="list-group list-group-flush mt-3">
        <li className="list-group-item">
          ...
          <ul className="mt-2">
            <li>
              ...
              La aplicación guarda el estado global (<strong>store</strong>) en{' '}
            ...
            <li>
              <i className="fa-solid fa-check text-success me-2"></i>
              Mejora el rendimiento y la experiencia en conexiones lentas.
            </li>
            <li className="mt-2 fst-italic text-muted">
              <i className="fa-solid fa-brain me-2"></i>
              Implementado usando <strong>localStorage</strong> +{' '}
        ...
        <li className="list-group-item mt-3">
          ...
          <ul className="mt-2">
            <li>
              <i className="fa-solid fa-check text-success me-2"></i>
              Barra de búsqueda global con autocompletado en tiempo real.
            </li>
            <li>
              <i className="fa-solid fa-check text-success me-2"></i>
              Soporta búsqueda de:
              <ul className="mt-1">
                <li>
                  <i className="fa-solid fa-user me-2"></i> Personajes
                </li>
                <li>
                  <i className="fa-solid fa-globe me-2"></i> Planetas
                </li>
                <li>
                  <i className="fa-solid fa-car-side me-2"></i> Vehículos
                </li>
              </ul>
            </li>
            <li>
              <i className="fa-solid fa-check text-success me-2"></i>
              Al hacer clic en una sugerencia, navega automáticamente a la vista
              detallada del elemento.
            </li>
            <li>
              <i className="fa-solid fa-check text-success me-2"></i>
              Facilita la exploración sin navegar manualmente por listas.
            </li>
            <li className="mt-2 fst-italic text-muted">
              <i className="fa-solid fa-bolt me-2"></i>
              Implementado con filtrado dinámico del <strong>store</strong> y
              navegación mediante <strong>React Router</strong>.
            </li>
          </ul>
        </li>
      </ul>
      ...
      <p className="mt-4 text-center">
        Este proyecto no solo demuestra el uso de React y APIs externas, sino
        también la capacidad de escalar una idea simple a múltiples fuentes de
        datos manteniendo una experiencia de usuario coherente.
      </p>
    </div>
  );
};
